...
typedef struct MethodInfo
{
    ...
    union
    {
        Il2CppRGCTXData* rgctx_data; /* is_inflated is true and is_generic is false, i.e. a generic instance method */
...
typedef struct Il2CppClass
{
    ...
    Il2CppRGCTXData* rgctx_data; // Initialized in Init
    ...
    uint8_t is_methods_initialized : 1;
    uint8_t size_init_pending : 1;
    uint8_t size_inited : 1;
    uint8_t has_finalize : 1;
    uint8_t has_cctor : 1;
    uint8_t is_cctor_initialized : 1;
    uint8_t is_blittable : 1;
    uint8_t is_import_or_windows_runtime : 1;
    uint8_t is_vtable_initialized : 1;
    uint8_t is_byref_like : 1;
    uint8_t is_virtual_method_initialized : 1;
