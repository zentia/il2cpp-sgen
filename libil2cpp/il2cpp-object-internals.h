...
static const size_t kIl2CppOffsetElementClass = (offsetof(Il2CppClass, element_class));
static const size_t kIl2CppOffsetElementSize = (offsetof(Il2CppClass, element_size));
