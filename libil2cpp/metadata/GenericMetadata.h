...
namespace metadata
{
    ...
    public:
        ...
        static Il2CppRGCTXData* InflateOneRGCTXLocked(Il2CppRGCTXData* data, const Il2CppImage* image, uint32_t token, int rgctxIndex, const Il2CppGenericContext* context, const il2cpp::os::FastAutoLock& lock);
