...
namespace metadata
{
	...
	typedef Il2CppHashSetMemory<Il2CppGenericClass*, Il2CppGenericClassHash, Il2CppGenericClassCompare> Il2CppGenericClassSet;
#else
    ...
    Il2CppRGCTXData* GenericMetadata::InflateRGCTXLocked(const Il2CppImage* image, uint32_t token, const Il2CppGenericContext* context, const FastAutoLock& lock)
    {
        ...
        vm::RGCTXCollection collection = MetadataCache::GetRGCTXs(image, token);
    ...
    Il2CppRGCTXData* GenericMetadata::InflateOneRGCTXLocked(Il2CppRGCTXData* data, const Il2CppImage* image, uint32_t token, int rgctxIndex, const Il2CppGenericContext* context, const il2cpp::os::FastAutoLock& lock)
    {
        // This method assumes that it has the g_MetadataLock
        ...
        {
            case IL2CPP_RGCTX_DATA_TYPE:
                data->type = GenericMetadata::InflateIfNeeded(MetadataCache::GetTypeFromRgctxDefinition(definitionData), context, true);
                break;
            case IL2CPP_RGCTX_DATA_CLASS:
                data->klass = Class::FromIl2CppType(GenericMetadata::InflateIfNeeded(MetadataCache::GetTypeFromRgctxDefinition(definitionData), context, true));
                Class::InitSizeAndFieldLayoutLocked(data->klass, lock);
                break;
            case IL2CPP_RGCTX_DATA_METHOD:
                data->method = GenericMethod::GetMethod(Inflate(MetadataCache::GetGenericMethodFromRgctxDefinition(definitionData), context));
                break;
            case IL2CPP_RGCTX_DATA_CONSTRAINED:
            {
                const Il2CppType* type;
