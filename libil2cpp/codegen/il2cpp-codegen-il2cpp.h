...
void il2cpp_codegen_gc_stacktrace_push_frame(int method);

void il2cpp_codegen_gc_stacktrace_pop_frame();
...
struct InsightGCProfilerSentry
{
    InsightGCProfilerSentry(int methodIndex)
    {
        il2cpp_codegen_gc_stacktrace_push_frame(methodIndex);
    }
    ~InsightGCProfilerSentry()
    { 
        il2cpp_codegen_gc_stacktrace_pop_frame();
    }
};
...
IL2CPP_FORCE_INLINE const VirtualInvokeData& il2cpp_codegen_get_virtual_invoke_data(Il2CppMethodSlot slot, const RuntimeObject* obj)
{
    ...
    if (!obj->klass->is_vtable_initialized)
        il2cpp::vm::ClassInlines::SetupVTable(obj->klass);
...
// generic sharing
inline RuntimeClass* il2cpp_rgctx_data(const RuntimeMethod* method, int32_t index)
{
    return InitializedTypeInfo(il2cpp::vm::ClassInlines::CheckRGCTX(method, index)->klass);
}

inline RuntimeClass* il2cpp_rgctx_data(const RuntimeClass* klass, int32_t index)
{
    return InitializedTypeInfo(il2cpp::vm::ClassInlines::CheckRGCTX(klass, index)->klass);
}

inline RuntimeClass* il2cpp_rgctx_data_no_init(const RuntimeMethod* method, int32_t index)
{
    return il2cpp::vm::ClassInlines::CheckRGCTX(method, index)->klass;
}

inline RuntimeClass* il2cpp_rgctx_data_no_init(const RuntimeClass* klass, int32_t index)
{
    return il2cpp::vm::ClassInlines::CheckRGCTX(klass, index)->klass;
}

inline const Il2CppType* il2cpp_rgctx_type(const RuntimeMethod* method, int32_t index)
{
    return il2cpp::vm::ClassInlines::CheckRGCTX(method, index)->type;
}

inline const Il2CppType* il2cpp_rgctx_type(const RuntimeClass* klass, int32_t index)
{
    return il2cpp::vm::ClassInlines::CheckRGCTX(klass, index)->type;
}

inline const MethodInfo* il2cpp_rgctx_method(const RuntimeMethod* method, int32_t index)
{
    return il2cpp::vm::ClassInlines::CheckRGCTX(method, index)->method;
}

inline const MethodInfo* il2cpp_rgctx_method(const RuntimeClass* klass, int32_t index)
{
    return il2cpp::vm::ClassInlines::CheckRGCTX(klass, index)->method;
}
...
inline const RuntimeMethod* GetVirtualMethodInfo(RuntimeObject* pThis, Il2CppMethodSlot slot)
{
    ...
    if (!pThis->klass->is_vtable_initialized)
        il2cpp::vm::ClassInlines::SetupVTable(pThis->klass);
