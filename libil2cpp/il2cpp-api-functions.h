...
DO_API(int, il2cpp_init, (const char* domain_name, bool class_full_setup_mode));
DO_API(int, il2cpp_init_utf16, (const Il2CppChar * domain_name, bool class_full_setup_mode));
...
// memory dump
DO_API(void, il2cpp_gc_dump_mem, (const char* file_path, bool isPrintLargeAlloc));
DO_API(void, il2cpp_gc_set_monitor_alloc, (bool isActive));

DO_API(void, il2cpp_set_parse_symbol_from_local, (bool parse_local));

DO_API(void, il2cpp_begin_trace_allocation, (Il2CppMonoAllocation func));
DO_API(void, il2cpp_end_trace_allocation, (Il2CppMonoAllocation func));
DO_API(void, il2cpp_insight_gc_stacktrace_open, (bool open));
DO_API(bool, il2cpp_insight_gc_stacktrace_is_enable, ());
DO_API(int, il2cpp_insight_get_gc_stacktrace, (unsigned long long* stack, short* module, int count));
