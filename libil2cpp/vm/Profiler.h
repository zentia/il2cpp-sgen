...
// exported
    public:
        ...
        static void AddAllocTracer(Il2CppMonoAllocation func);
        static void RemoveAllocTracer(Il2CppMonoAllocation func);
...
// internal
    public:
        static void Allocation(Il2CppObject *obj, Il2CppClass *klass, size_t size);
