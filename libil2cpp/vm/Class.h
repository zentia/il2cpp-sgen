...
namespace vm
{
    ...
    public:
        ...
        static void SetupCCtorMethods(Il2CppClass* klass);
        static void SetupVirtualMethods(Il2CppClass *klass);
        ...
        static void GetBitmap(Il2CppClass* klass, DWord* bitmap, size_t& maxSetBit);
