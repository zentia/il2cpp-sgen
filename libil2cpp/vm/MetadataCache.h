...
namespace vm
{
    ...
    typedef Il2CppHashMapKeyWrapper<il2cpp::metadata::Il2CppSignature, int32_t, il2cpp::metadata::Il2CppSignatureHash, il2cpp::metadata::Il2CppSignatureCompare> Il2CppUnresolvedSignatureMap;
#if IL2CPP_TARGET_IOS
    typedef Il2CppHashMapMemory<const Il2CppGenericMethod*, const Il2CppGenericMethodIndices*, il2cpp::metadata::Il2CppGenericMethodHash, il2cpp::metadata::Il2CppGenericMethodCompare> Il2CppMethodTableMap;
#else
    ...
    public:
        ...
        static DWord* GetDescTablePointer();
        static int GetDescTableLength();
    private:
