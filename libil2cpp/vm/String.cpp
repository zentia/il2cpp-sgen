...
namespace vm
{
    ...
    {
#if ENABLE_GC_PROFILE
        il2cpp::vm::InsightGCStackTrace::InsightGCProfilerInnerSentry _sentry((int)il2cpp::vm::InsightGCStackTrace::ALLOCATION_STRING_NEWSIZE);
#endif
        if (len == 0)
            return Empty();
...
#if ENABLE_GC_PROFILE
        Profiler::Allocation((Il2CppObject*)s, il2cpp_defaults.string_class, size);
