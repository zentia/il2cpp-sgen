...
namespace vm
{
    ...
    void ClassInlines::SetupVTable(Il2CppClass* klass)
    {
    ...
    void ClassInlines::InitRGCTXLocked(Il2CppRGCTXData* rgctx_data, const MethodInfo* method, int index)
    {
        Class::InitRGCTXLocked(rgctx_data, method, index);
    }

    void ClassInlines::InitRGCTXLocked(Il2CppRGCTXData* rgctx_data, const Il2CppClass* klass, int index)
    {
        Class::InitRGCTXLocked(rgctx_data, klass, index);
    }
}
}
