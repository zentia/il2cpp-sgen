...
// 3. Out of options - create Il2CppComObject
    ...
    Il2CppObject* ReboxIReference(Il2CppIUnknown* comObject, Il2CppClass* objectClass)
    {
        ...
        if (!objectClass->is_vtable_initialized)
            il2cpp::vm::Class::SetupVTable(objectClass);
    ...
    Il2CppObject* ReboxKeyValuePair(Il2CppIUnknown* comObject, Il2CppClass* keyValuePairGenericInstance)
    {
        ...
        if (!iKeyValuePairGenericInstance->is_vtable_initialized)
            il2cpp::vm::Class::SetupVTable(iKeyValuePairGenericInstance);
    ...
    Il2CppObject* ReboxUri(Il2CppIUnknown* comObject)
    {
        ...
        if (!iUriRuntimeClassClass->is_vtable_initialized)
            il2cpp::vm::Class::SetupVTable(iUriRuntimeClassClass);
