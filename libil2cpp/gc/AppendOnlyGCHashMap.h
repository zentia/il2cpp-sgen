...
namespace gc
{
    ...
    {
        typedef Il2CppHashMapKeyWrapper<Key, size_t, HashFcn, EqualKey> hash_map_type;
        typedef typename Il2CppHashMapKeyWrapper<Key, size_t, HashFcn, EqualKey>::const_iterator ConstIterator;
    public:
    ...
    private:
        ...
        Il2CppHashMapKeyWrapper<Key, size_t, HashFcn, EqualKey> m_Map;
        T* m_Data;
        size_t m_Size;
