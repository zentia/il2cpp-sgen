...
namespace
{
    ...
    void StackTrace::WalkStackNativeAllInOnce(WalkStackCallbackAllInOnce callback, void* context, WalkOrder walkOrder)
    {
        AndroidStackTrace callstack = {};
        _Unwind_Backtrace(AndroidStackTrace::Callback, &callstack);

        callback(reinterpret_cast<Il2CppMethodPointer*>(callstack.addrs), callstack.size, context, static_cast<int>(walkOrder));
