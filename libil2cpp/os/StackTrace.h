...
namespace os
{
    ...
    typedef bool(*WalkStackCallbackAllInOnce)(Il2CppMethodPointer* frames, size_t frameCount, void* context, int walkOrder);
    ...
    public:
        ...
        static void WalkStackAllInOnce(WalkStackCallbackAllInOnce callback, void* context, WalkOrder walkOrder);
    ...
    private:
        ...
        static void WalkStackNativeAllInOnce(WalkStackCallbackAllInOnce callback, void* context, WalkOrder walkOrder);
    };
}
}
