...
#define IL2CPP_ENABLE_STACKTRACE_PC_ADDRESS (IL2CPP_TARGET_ANDROID || IL2CPP_TARGET_IOS) && !IL2CPP_MONO_DEBUGGER
...
#ifndef SGAME_SECTION
#define SGAME_SECTION(section)
#endif



#if ENABLE_GC_MEMDUMP == 1
#if IL2CPP_TARGET_IOS || IL2CPP_TARGET_ANDROID
	#define IL2CPP_GC_MEM_DUMP (1)
#else
	#define IL2CPP_GC_MEM_DUMP (0)
#endif
#else
#define IL2CPP_GC_MEM_DUMP (0)
#endif

#define ENABLE_GC_VECTOR_MALLOC 0