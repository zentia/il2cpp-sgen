...
#define FWORDSZ ((word)(8*sizeof(GC_fword)))
#define FSIGNB ((GC_fword)1 << (FWORDSZ - 1))
...
# ifdef GLOBAL_SHARE_FREE_LIST

#   define GC_globalfreelist GC_arrays._globalfreelist
    void *_globalfreelist[MAXOBJGRANULES+1];

#   define GC_objfreelist GC_arrays._globalfreelist//GC_arrays._objfreelist
//    void *_objfreelist[MAXOBJGRANULES+1];

#   define GC_aobjfreelist GC_arrays._aobjfreelist//GC_arrays._globalfreelist
...
#   define GC_uobjfreelist GC_arrays._uobjfreelist
    void *_uobjfreelist[MAXOBJGRANULES+1];
                          ...
                          /* garbage collections.               */
#   define GC_suobjfreelist GC_arrays._suobjfreelist                  
    void *_suobjfreelist[MAXOBJGRANULES + 1];
                          /* free list for static uncollectible object */
...
#define UNCOLLECTABLESTATIC 3
#ifdef GC_ATOMIC_UNCOLLECTABLE
# define AUNCOLLECTABLE 4
# define IS_UNCOLLECTABLE(k) (((k) & ~1) == UNCOLLECTABLE || (k) == AUNCOLLECTABLE)
...
# endif
  ...
  GC_EXTERN ptr_t * GC_gcjarrayobjfreelist;
#endif
