...
# if defined(__int64) && !defined(CPPCHECK)
    typedef unsigned __int64 GC_fword;
    typedef unsigned __int64 GC_word;
    typedef __int64 GC_signed_word;
# else
    typedef unsigned long long GC_fword;
...
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void * GC_CALL
        GC_malloc_static_uncollectable(size_t /* size_in_bytes */,size_t /* size_in_descr */);
...
# define GC_MALLOC_STATIC_UNCOLLECTABLE(sz,descr) GC_malloc_static_uncollectable(sz,descr)
# define GC_MALLOC_IGNORE_OFF_PAGE(sz) \
