...
//#define GC_INITIAL_HEAP_SIZE 32 * 1024 * 1024

#define ATOMIC_UNCOLLECTABLE 1

#define EAGER_SWEEP 1

#define DONT_ADD_BYTE_AT_END 1

//#define GLOBAL_SHARE_FREE_LIST 1

//used custom-mode desc
#define MAKE_BITMAP_DESC

//#define GC_DUMP_REGULARLY 1
//#define GC_ANDROID_LOG 1

//#define PRINT_BLACK_LIST 1
