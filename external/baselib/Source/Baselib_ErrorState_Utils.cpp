...
BASELIB_CPP_INTERFACE
{
    namespace detail
    {
        ...
        public:
            ...
            omemstream& TryReadInto(omemstream& out, uint64_t generationCounter)
            {
                lock.Acquire();
    ...
    omemstream& operator<<(omemstream& os, const Baselib_ErrorCode& errorCode)
    {
        switch (errorCode)
        {
        ...
        os.formatString(" (0x%08x)", (uint32_t)errorCode);
        return os;
    }
