...
namespace PosixApi
{
    ...
    BASELIB_STATIC_ASSERT(Baselib_SystemSemaphore_PlatformSize >= sizeof(sem_t), "Baselib_SystemSemaphore_PlatformSize must be same size or greater than internal representation");

    BASELIB_INLINE_IMPL Baselib_SystemSemaphore_Handle Baselib_SystemSemaphore_CreateInplace(void* semaphoreData)
    {
        sem_t* sem = static_cast<sem_t*>(semaphoreData);
    ...
    BASELIB_INLINE_IMPL Baselib_SystemSemaphore_Handle Baselib_SystemSemaphore_Create()
    {
        ...
        return Baselib_SystemSemaphore_CreateInplace(Baselib_Internal_Memory_Allocate(sizeof(sem_t)));
    }
    ...
    BASELIB_INLINE_IMPL void Baselib_SystemSemaphore_FreeInplace(Baselib_SystemSemaphore_Handle semaphore)
    {
    ...
    {
        PosixApi::Baselib_SystemSemaphore_FreeInplace(semaphore);
        Baselib_Internal_Memory_Free(::detail::AsNativeType<sem_t*>(semaphore));
    }
}
