...
namespace platform
{
    ...
    constexpr auto Baselib_Memory_AllocatePages = PosixApi::Baselib_Memory_AllocatePages<false>;
    using PosixApi::Baselib_Memory_ReleasePages;
    constexpr auto Baselib_Memory_SetPageState = DarwinApi::Baselib_Memory_SetPageState<false>;
}
